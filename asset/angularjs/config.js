...
require.config({
    ...
    paths: {
        ...
        'flatted': '/modules/flatted/index',
        'lscache': 'https://cdnjs.cloudflare.com/ajax/libs/lscache/1.3.0/lscache.min',
        'node_generic_functions': '/modules/node_generic_functions/genericfunctions',
        'moment':'https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.2/moment.min',
        'basictable': '/modules/basictable/jquery.basictable.min',
        ...
        'fullcalendar':'/modules/fullcalendar/fullcalendar.min',
        'ui.calendar':'https://cdnjs.cloudflare.com/ajax/libs/angular-ui-calendar/1.0.0/calendar.min',
        'combinatorics':'/modules/js-combinatorics/combinatorics',
    },
